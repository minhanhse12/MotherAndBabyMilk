...
public class Filter extends OncePerRequestFilter {
    ...
    private final List<String> AUTH_PERMISSIONS = List.of("/swagger-ui/**", "/v3/api-docs/**", "/swagger-resources/**", "/api/login", "/api/register", "/api/request-reset-password","/reset-password", "/api/reset-password/**");
